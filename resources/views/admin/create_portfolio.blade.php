        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="card-title text-light">Create Portfolio</h3>
                </div>
                <div class="card-body">
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ route('CreatePortfolio') }}" enctype="multipart/form-data">
                        @csrf
                        <div class=" row mb-4">
                            <label for="inputName" class="col-md-3 form-label">Nama</label>
                            <div class="col-md-9">
                                <input type="text" name="nama" class="form-control" id="inputName" placeholder="Masukan Nama">
                            </div>
                        </div>
                        <div class=" row mb-4">
